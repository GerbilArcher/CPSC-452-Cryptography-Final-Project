...
#sample input for encryption: python3 ecb.py -key 1234567890abcdef -infile webcomic.jpg -outfile webcomic.enc -encdec 0
#sample input for decryption: python3 ecb.py -key 1234567890abcdef -infile webcomic.enc -outfile decrypted_webcomic.jpg -encdec 1
